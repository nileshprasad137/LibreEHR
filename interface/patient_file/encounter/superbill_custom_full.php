...
<table class="table">
 ...
 <tr>
  ...
  <td>
   ...
   <?php if ($mode == "modify") { ?>
      <input type='text' class="form-control" name='code_type' readonly='readonly' style='display:none' value='<?php echo attr($code_type) ?>' />
      <?php echo attr($code_type_name_external) ?>
   <?php } ?>
   <?php echo xlt('Code'); ?>:      
   <?php if ($mode == "modify") { ?>
     <input type='text' name='code' readonly='readonly' value='<?php echo attr($code) ?>' />
   <?php } else { ?>
     <input type='text'   class="form-inline" size='6' name='code' value='<?php echo attr($code) ?>'
...
<?php } ?>
 ...
 <tr>
  ...
  <td>
   ...
   <?php if ($mode == "modify") { ?>
     <input type='text'  class="form-control form-rounded" size='50' name="code_text" readonly="readonly" value='<?php echo attr($code_text) ?>'>
   <?php } else { ?>
     <input type='text'  class="form-control form-rounded" size='50' name="code_text" value='<?php echo attr($code_text) ?>'>
   <?php } ?>
...
?>
 ...
 <tr<?php if (empty($GLOBALS['ippf_specific'])) echo " style='display:none'"; ?>>
  ...
  <td></td>
  <td>
   <input type='text'  class="form-control form-rounded" size='10' maxlength='20' name="cyp_factor" value='<?php echo attr($cyp_factor) ?>'>
  </td>
 </tr>
 ...
 <tr<?php if (!related_codes_are_used()) echo " style='display:none'"; ?>>
  ...
  <td></td>
  <td>
   <input type='text'  class="form-control form-rounded" size='50' name='related_desc'
...
<table class="table">
 <tr>
  ...
  <td class='text'>
   <select class="form-control" name='filter[]' multiple='multiple'>
<?php
foreach ($code_types as $key => $value) {
...
?>
  ...
  <input type="text" class="form-control" name="search" size="5" value="<?php echo attr($search) ?>"><br>
